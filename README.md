...
- `ProtocolLab`: structured BLE packet capture, `005E` filtering, A5 frame detection, focused timeline reports, JSON/CSV export.
...
4. Use **Lab** to filter `005E`, inspect the button timeline, copy JSON/CSV, and fill the Wi-Fi Import checklist.
...
See `docs/chat-context.md` for the preserved reverse-engineering notes from prior ChatGPT sessions.
